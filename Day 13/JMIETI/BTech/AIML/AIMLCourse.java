package JMIETI.BTech.AIML;

import java.util.Scanner;

public class AIMLCourse 
{
    public AIMLCourse()
    {
    ...
    {
        System.out.println("The duration of CS(AIML) Course is 4 Years");
    }
    public static void fees()
    {
        Scanner sc = new Scanner(System.in);
        System.out.println("Welcome to CS(AIML) Fees");
