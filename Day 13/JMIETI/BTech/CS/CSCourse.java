...
public class CSCourse 
{
    public CSCourse()
    {
        ...
        while(repeat)
        {
            ...
            System.out.println("\n        Course Detail of COMPUTER SCIENCE : ");
    ...
    {
        System.out.println("The duration of Computer Science Course is 4 Years");
    }
    public static void fees()
    {
        Scanner sc = new Scanner(System.in);
        System.out.println("Welcome to Computer Science Fees");
