package JMIETI.ComputerApplication.BCA;
import java.util.Scanner;

public class BCACourse
{
    public BCACourse()
    {
    ...
    {
        System.out.println("The duration of BCA Course is 3 Years");
    }
    public static void fees()
    {
        Scanner sc = new Scanner(System.in);
        System.out.println("Welcome to BCA Fees");
