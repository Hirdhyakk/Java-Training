package JMIETI.Management.BBA;

import java.util.Scanner;

public class BBACourse
{
    public BBACourse()
    {
    ...
    {
        System.out.println("The duration of BBA Course is 3 Years");
    }
    public static void fees()
    {
        Scanner sc = new Scanner(System.in);
        System.out.println("Welcome to BBA Fees");
