package JMIETI.Management.MBA;

import java.util.Scanner;

public class MBACourse
{
    public MBACourse()
    {
    ...
    {
        System.out.println("The duration of MBA Course is 3 Years");
    }
    public static void fees()
    {
        Scanner sc = new Scanner(System.in);
        System.out.println("Welcome to MBA Fees");
